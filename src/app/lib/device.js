export function DeviceDetails() {
    ...
    var module = {
        ...
        dataos: [
            ...
            { name: 'iPad', value: 'iPad', version: 'OS',type:'tab' },
            { name: 'Kindle', value: 'Silk', version: 'Silk' ,type:'tab'},
            ...
            { name: 'Macintosh', value: 'Mac', version: 'OS X' ,type:'web'},
            { name: 'Linux', value: 'Linux', version: 'rv' ,type:'web'},
            { name: 'Palm', value: 'Palm', version: 'PalmOS' ,type:'web'}
        ],
        databrowser: [
