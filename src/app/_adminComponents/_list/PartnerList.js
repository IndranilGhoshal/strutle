        ...
        <>
            <div className="mastr_hw">
                ...
                <div className="assects_src_dvadd">
                    ...
                    <button className="btn btn-dwn p-0 dropdown-toggle" data-bs-toggle="dropdown" aria-expanded="false">Filter Partner List <i className="bi bi-sliders"></i></button>
                    <div className="dropdown-menu dropdown-menu-end">
                        <div className="filter-lists">
                            <label>Filter by Partner Status</label>
                            <select
                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th align="left">Partner Name <i style={{ cursor: "pointer" }} className="bi bi-arrow-down-up" onClick={() => { namesortFun() }}></i></th>
                                                ...
                                                <div className="dropdown-menu dropdown-menu-end">
                                                    <div className="filter-lists">
                                                        <div className='edtbtn'>
                                                            <button><i className="bi bi-person-workspace mx-2"></i> View Partner</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </td>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list.length} partner{list.length > 1 ? "s" : ""} <strong>per page</strong></span>
