                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th align="left">Sub-Category Name <i style={{ cursor: "pointer" }} className="bi bi-arrow-down-up" onClick={() => { namesortFun() }}></i></th>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list.length} Sub{list.length > 1 ? "-Categories" : "-Category"} <strong>per page</strong></span>
