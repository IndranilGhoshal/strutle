                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th align="left">Admin Name <i style={{ cursor: "pointer" }} className="bi bi-arrow-down-up" onClick={() => { namesortFun() }}></i></th>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{user.length} user{user.length > 1 ? "s" : ""} <strong>per page</strong></span>
