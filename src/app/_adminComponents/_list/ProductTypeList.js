                        ...
                        <table className="table table-hover">
                            <thead>
                                <tr role="row">
                                    ...
                                    <th align="left">Product Type Name <i style={{ cursor: "pointer" }} className="bi bi-arrow-down-up" onClick={() => { namesortFun() }}></i></th>
                                    <th align="left">Category Name</th>
                                    <th align="left">Sub-Category Name</th>
                                    <th align="left">No of Items</th>
                                    <th align="left">No of Attribute</th>
...

                                {
                                    list.length > 0 ? list.map((item, i) => (
                                        <tr role="row" key={i}>
                                            ...
                                            <td align="left">{item.subcategory}</td>
                    ...
                    <div className="paginati">
                        <div className="paginati_l">
                            ...
                            <div className="dataTables_length d-flex align-items-center" id="datatables-reponsive_length">
                                ...
                                <span>{list.length} Product Type{list.length > 1 ? "s" : ""} <strong>per page</strong></span>
